...
export const bagpipes: BagpipeType[] = [
  ...
  { mode: Modes.Ionian, holesCount: 8, name: 'Spanish Gaita', type: Bagpipes.SpanishGaita },
  { mode: Modes.Eolian, holesCount: 8, name: 'Deutsch Dudelsack', type: Bagpipes.DeutschDudelsack },
];
